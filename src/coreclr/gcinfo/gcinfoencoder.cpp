...
void GcInfoSize::Log(DWORD level, const char * header)
{
    if (GCINFO_LOGSPEW(level, header))
    {
        ...
        GCINFO_LOGSPEW(LF_GCINFO, level, "---COUNTS---\n");
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumMethods: %zu\n", NumMethods);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumCallSites: %zu\n", NumCallSites);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumRanges: %zu\n", NumRanges);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumRegs: %zu\n", NumRegs);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumStack: %zu\n", NumStack);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumUntracked: %zu\n", NumUntracked);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumTransitions: %zu\n", NumTransitions);
        GCINFO_LOGSPEW(LF_GCINFO, level, "SizeOfCode: %zu\n", SizeOfCode);
        GCINFO_LOGSPEW(LF_GCINFO, level, "EncInfoSize: %zu\n", EncInfoSize);

        GCINFO_LOGSPEW(LF_GCINFO, level, "---SIZES(bits)---\n");
        GCINFO_LOGSPEW(LF_GCINFO, level, "Total: %zu\n", TotalSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "UntrackedSlot: %zu\n", UntrackedSlotSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumUntracked: %zu\n", NumUntrackedSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "Flags: %zu\n", FlagsSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "CodeLength: %zu\n", CodeLengthSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "Prolog/Epilog: %zu\n", ProEpilogSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "SecObj: %zu\n", SecObjSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "GsCookie: %zu\n", GsCookieSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "GenericsCtx: %zu\n", GenericsCtxSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "StackBase: %zu\n", StackBaseSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "FixedArea: %zu\n", FixedAreaSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "ReversePInvokeFrame: %zu\n", ReversePInvokeFrameSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumCallSites: %zu\n", NumCallSitesSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumRanges: %zu\n", NumRangesSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "CallSiteOffsets: %zu\n", CallSitePosSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "Ranges: %zu\n", RangeSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumRegs: %zu\n", NumRegsSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "NumStack: %zu\n", NumStackSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "RegSlots: %zu\n", RegSlotSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "StackSlots: %zu\n", StackSlotSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "CallSiteStates: %zu\n", CallSiteStateSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "EhOffsets: %zu\n", EhPosSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "EhStates: %zu\n", EhStateSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "ChunkPointers: %zu\n", ChunkPtrSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "ChunkMasks: %zu\n", ChunkMaskSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "ChunkFinalStates: %zu\n", ChunkFinalStateSize);
        GCINFO_LOGSPEW(LF_GCINFO, level, "Transitions: %zu\n", ChunkTransitionSize);
    }
}
