...
void ComMethodTable::LayOutClassMethodTable()
{
    ...
    {
        ExecutableWriterHolderC<BYTE> methodDescMemoryWriteableHolder;
        //
        ...
        if (cbAlloc > 0)
        {
            ...
            methodDescMemoryWriteableHolder = ExecutableWriterHolderC<BYTE>::Create(pMethodDescMemory, cbAlloc + sizeof(UINT_PTR));
